...
class NepaliASR:
    ...
    # Method for ASR through file name API
    ...
    # Method for ASR through file name with sampling rate if required along with splitting on silence
    def speech_recognition_file(self, audio, sample_rate=16000):
        ...
        transcription = " ".join(transcriptions)
        return transcription
    # Method to transcribe the audio
...
# Function to convert AudioSegment object to librosa data
...
# Function to convert file to audio segments
